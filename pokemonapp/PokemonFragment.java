...
public class PokemonFragment extends Fragment { //Fragment code 1
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstance) {
        ...
        pokeName = (TextView) myView.findViewById(R.id.pokemonName);
        pokePic = (ImageView) myView.findViewById(R.id.pokemonPic);
        forwardButton = (Button) myView.findViewById(R.id.forwardButton);
        ...
        pokeInfo = (ListView) myView.findViewById(R.id.statsListView);
