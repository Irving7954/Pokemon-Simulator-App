...
public class TeamFragment extends Fragment { //fragment code 2
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstance) {
        ...
        team1Button = (Button) myView.findViewById(R.id.team1Button);
        team2Button = (Button) myView.findViewById(R.id.team2Button);
        team3Button = (Button) myView.findViewById(R.id.team3Button);
